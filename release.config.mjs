export default {
  ...
  plugins: [
    ...
    // 4.0.0 onward as a bare header with no body, hiding 4.0.0's breaking changes entirely.
    ...
    // cosmetic, so it goes last where its failure cannot strand a registry.
